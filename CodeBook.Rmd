...
========================================================
This documen describes the variables, the data, and any transformations or work
...
Only the measurements on the mean and standard deviatian for each measurement 
are in scope of this analsis. 
...
Names are normalised by setting it to lower case and removing any bracket
characters.

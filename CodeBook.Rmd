...
Only the measurements on the mean and the standard deviation for each measurement are in scope of this analysis, a simple regular expression identifies the important features.
